...
import com.codely.robot.primaryadapter.rest.route.RouteRobotDTO

object RouteRobotDTOMother {

    fun invoke() = RouteRobotDTO(
        route = "mpjyHx`i@VjAVKnAh@BHHX@LZR@Bj@Ml@WWc@]w@bAyAfBmCb@o@pLeQfCsDVa@@ODQR}AJ{A?{BGu\n" +
